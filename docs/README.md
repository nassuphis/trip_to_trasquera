...
Τα έργα της Σίγκριντ Νασούφη, λάδι σε μουσαμά, είναι δημιουργίες που ξεκίνησαν μετά το θάνατο του άντρα της. Στο πένθος η φράση που επαναλαμβάνεται από συγγενείς και φίλους, είναι “δεν έχω λόγια.” Η Σίγκριντ άφησε τα λόγια στην άκρη- οι λέξεις 
μπήγονται σαν καρφιά- και δημιούργησε μια σειρά από τοπία με βοηθό τη φωτογραφία και οδηγό τη μνήμη.  Ζωγράφισε την απουσία. Η ομορφιά υπάρχει, η αρμονία γαληνεύει, η απουσία ανθρώπων σημαίνει. Σκιές και φως, γαλήνη και απειλή.

Η φύση έχει προοπτική όταν οι άνθρωποι φεύγουν. Είναι παρηγορητική στο μεγαλείο και την ομορφιά της. ‘Σε γυρεύω  σε τόπους που μοιάζουν αθάνατοι’, σαν να λέει. ‘Να, κοίτα  τα βουνά που πήγα με τους γιους μας όταν έφυγες!’  Τα ψηλά βουνά που αγάπησε, που περπάτησε και περπατάει η Σίγκριντ και στην όγδοη δεκαετία της ζωής της είναι ο σύνδεσμος της με τη  ζωή. Με οδηγούς τα χρώματα και τα πινέλα ανοίγει ένα  μονοπάτι. Αυτό που οι όμορφοι ξύλινοι φράχτες μπροστά από τους επιβλητικούς ορεινούς όγκους δεν μπορούν να κλείσουν.
